...
class RealisasiPenyetoranUleController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('realization.penyetoran-ule.list-store-ule-realization', compact('proyeksiAll'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('realization.penyetoran-ule.form-store-ule-realization-add', compact('sisaUk100000', 'sisaUk50000', 'sisaUk20000', 'sisaUk10000', 'sisaUk5000', 'sisaUk2000', 'sisaUk1000', 'sisaUl1000', 'sisaUl500', 'sisaUl200', 'sisaUl100', 'sisaUl50'));
    ...
    public function show(string $id)
    {
        ...
        return view('realization.penyetoran-ule.form-store-ule-realization-view', compact('proyeksiView'));
    }
