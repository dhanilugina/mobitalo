...
class ProyeksiPenarikanController extends Controller
{
    /**
    ...
    {
        //form-withdrawal-projection-add
        return view('projection.form-withdrawal-projection-add');
    }
    ...
    public function store(Request $request)
    {
        ...
        $withdrawalProjection = StoreProjection::create([
        ...
        return redirect()->route('withdrawalProjection.index')->with($notification);
    }
    ...
    {
        $proyeksiView = withdrawalProjection::findOrFail($id);
        return view('projection.form-withdrawal-projection-view', compact('proyeksiView'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('projection.form-withdrawal-projection-edit', compact('proyeksiEdit'));
    }
