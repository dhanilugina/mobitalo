        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Proyeksi Pemusnahan</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="mb-4">
                            <a href="{{ route('destructionProjection.add') }}" class="btn btn-primary btn-rounded fs-18">+ Tambah Proyeksi</a>
                        </div>
                    </div>
                                    ...
                                    <td>
                                        <div class="dropdown ms-auto text-end">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item" href="{{ route('destructionProjection.view',$item->id)}}">View</a>
                                                <a class="dropdown-item" href="{{ route('destructionProjection.edit',$item->id)}}">Edit</a>
                                                <a class="dropdown-item" href="{{ route('destructionProjection.delete', $item->id) }}" id="delete">Delete</a>
