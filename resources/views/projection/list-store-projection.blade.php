        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="mb-4">
                            <a href="{{ route('storeProjection.add') }}" class="btn btn-primary btn-rounded fs-18">+ Tambah Proyeksi</a>
                        </div>
                    </div>
                                    ...
                                    <td>
                                        <div class="dropdown ms-auto text-end">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item" href="{{ route('storeProjection.view',$item->id)}}">View</a>
                                                <a class="dropdown-item" href="{{ route('storeProjection.edit',$item->id)}}">Edit</a>
                                                <a class="dropdown-item" href="{{ route('storeProjection.delete', $item->id) }}" id="delete">Delete</a>
