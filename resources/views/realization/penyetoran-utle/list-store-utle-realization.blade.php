...
<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item" aria-current="page">Penyetoran Utle</li>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Realisasi Penyetoran UTLE Ke Bank Indonesia</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                    <div class="mb-4">
                        ...
                        $today = date('m-Y', time());
                        @endphp
                        <a href="{{ route('storeUtleRealization.add', ['periode' => $today]) }}" class="btn btn-primary btn-rounded fs-18">+ Tambah Realisasi</a>
                    </div>
                    </div>
                                    ...
                                    <td>
                                        <div class="dropdown ms-auto text-end">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item" href="{{ route('storeUtleRealization.view',$item->id)}}">View</a>
                                                <!-- <a class="dropdown-item" href="">Edit</a> -->
                                                <a class="dropdown-item" href="{{ route('storeUtleRealization.delete',$item->id)}}" id="delete">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
