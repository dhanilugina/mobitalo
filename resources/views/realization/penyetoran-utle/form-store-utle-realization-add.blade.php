	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card">
				...
				<div class="card-body">
					<div class="row">
						<form class="needs-validation" novalidate method="get" action="{{ route('storeUtleRealization.add') }}">
							@csrf
							<div class="mb-3 row">
						...
						<form class="needs-validation" novalidate method="post" action="{{ route('storeUtleRealization.store') }}" id="myForm">
							@csrf
							<div class="mb-3 row">
