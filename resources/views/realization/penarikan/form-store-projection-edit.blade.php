		...
		<div class="col-lg-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">Realisasi Penyetoran ke Bank Indonesia</h4>
				</div>
				<div class="card-body">
					<div class="row">
						<form class="needs-validation" novalidate method="POST" action="{{ route('storeProjection.update') }}" enctype="multipart/form-data">
							@csrf
							<div class="mb-3 row">
