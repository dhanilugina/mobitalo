	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card">
				...
				<div class="card-body">
					<div class="row">
						<form class="needs-validation" novalidate method="get" action="{{ route('withdrawalRealization.add') }}">
							@csrf
							<div class="mb-3 row">
						...
						<form class="needs-validation" novalidate method="POST" action="{{ route('withdrawalRealization.store') }}" id="myForm">
							@csrf
							<div class="mb-3 row">
