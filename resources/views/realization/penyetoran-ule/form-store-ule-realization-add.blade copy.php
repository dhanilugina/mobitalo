...
<div class="row">
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item" aria-current="page">Penyetoran Ule</li>
		...
		<div class="col-lg-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">Realisasi Penyetoran ULE ke Bank Indonesia</h4>
				</div>
				<div class="card-body">
					<div class="row">
									...
									<div class="tab-content">
										<div id="navpills-1" class="tab-pane active">
											...
											<div class="row">
												...
												<div class="mb-3 row">
													...
													<div class="col-lg-4">
														<input type="text" class="form-control" value="{{ $sisaUk50000 }}" disabled>
													</div>
												</div>
												...
												<div class="mb-3 row">
													...
													<div class="col-lg-4">
														<input type="text" class="form-control" id="uk_20000" name="uk_20000" placeholder="ie. 20.000" required>
														<div class="invalid-feedback">
															Please enter a username.
														</div>
													</div>
													<div class="col-lg-4">
														<input type="text" class="form-control" value="{{ $sisaUk20000 }}" disabled>
													</div>
												</div>
												...
												<div class="mb-3 row">
													...
													<div class="col-lg-4">
														<input type="text" class="form-control" id="uk_10000" name="uk_10000" placeholder="ie. 10.000" required>
														<div class="invalid-feedback">
															Please enter a username.
														</div>
													</div>
													<div class="col-lg-4">
														<input type="text" class="form-control" value="{{ $sisaUk10000 }}" disabled>
													</div>
												</div>
												...
												<div class="mb-3 row">
													...
													<div class="col-lg-4">
														<input type="text" class="form-control" id="uk_5000" name="uk_5000" placeholder="ie. 5.000" required>
														<div class="invalid-feedback">
															Please enter a username.
														</div>
													</div>
													<div class="col-lg-4">
														<input type="text" class="form-control" value="{{ $sisaUk5000 }}" disabled>
													</div>
												</div>
												...
												<div class="mb-3 row">
													...
													<div class="col-lg-4">
														<input type="text" class="form-control" id="uk_2000" name="uk_2000" placeholder="ie. 2.000" required>
														<div class="invalid-feedback">
															Please enter a username.
														</div>
													</div>
													<div class="col-lg-4">
														<input type="text" class="form-control" value="{{ $sisaUk2000 }}" disabled>
													</div>
												</div>
												...
												<div class="mb-3 row">
													...
													<div class="col-lg-4">
														<input type="text" class="form-control" id="uk_1000" name="uk_1000" placeholder="ie.  1.000" required>
														<div class="invalid-feedback">
															Please enter a username.
														</div>
													</div>
													<div class="col-lg-4">
														<input type="text" class="form-control" value="{{ $sisaUk1000 }}" disabled>
													</div>
												</div>
											</div>
										</div>
										<div id="navpills-2" class="tab-pane">
											...
											<div class="mb-3 row">
												...
												<div class="col-lg-4">
													<input type="text" class="form-control" value="{{ $sisaUl1000 }}" disabled>
												</div>
											</div>
											...
											<div class="mb-3 row">
												...
												<div class="col-lg-4">
													<input type="text" class="form-control" value="{{ $sisaUl500 }}" disabled>
												</div>
											</div>
											...
											<div class="mb-3 row">
												...
												<div class="col-lg-4">
													<input type="text" class="form-control" value="{{ $sisaUl200 }}" disabled>
												</div>
											</div>
											...
											<div class="mb-3 row">
												...
												<div class="col-lg-4">
													<input type="text" class="form-control" value="{{ $sisaUl100 }}" disabled>
												</div>
											</div>
											...
											<div class="mb-3 row">
												...
												<div class="col-lg-4">
													<input type="text" class="form-control" value="{{ $sisaUl50 }}" disabled>
												</div>
											</div>
										</div>
									</div>
