            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        $today = date('m-Y', time());
                        @endphp
                        <a href="{{ route('storeUleRealization.add', ['periode' => $today]) }}" class="btn btn-primary btn-rounded fs-18">+ Tambah Realisasi</a>
                    </div>
                    </div>
                                    ...
                                    <td>
                                        <div class="dropdown ms-auto text-end">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item" href="{{ route('storeUleRealization.view',$item->id)}}">View</a>
                                               <!-- <a class="dropdown-item" href="">Edit</a> -->
                                                <a class="dropdown-item" href="{{ route('storeUleRealization.delete',$item->id)}}" id="delete">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
