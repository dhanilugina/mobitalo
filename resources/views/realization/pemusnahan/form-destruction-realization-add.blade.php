	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card">
				...
				<div class="card-body">
					<div class="row">
						<form class="needs-validation" novalidate method="get" action="{{ route('destructionRealization.add') }}">
							@csrf
							<div class="mb-3 row">

								<div class="col-lg-3">
									<label class="col-form-label">Periode Pemusnahan
									</label>
								</div>
						...
						<form class="needs-validation" novalidate method="POST" action="{{ route('destructionRealization.store') }}" id="myForm">
							@csrf
							<div class="mb-3 row">
