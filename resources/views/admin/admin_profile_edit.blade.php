                    ...
                    <div class="basic-form">
                        <form method="post" action="{{ route('store.profile') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" class="form-control" placeholder="Email" value="{{ $editData->email}}" name="email" readonly>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label class="col-sm-3 col-form-label">Fullname</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" placeholder="Fullname" value="{{ $editData->name}}" name="name">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <div class="profile-photo">
                                        <input type="file" class="form-file-input form-control" name="profile_image" id="image">
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <img id="showImage" src="{{ (!empty($editData->profile_image))? url('upload/admin_images/'.$editData->profile_image):url('upload/no_image.jpg') }}" width="100" height="100" class="img-fluid rounded" alt="">
                                </div>
                            </div>
